...
?>
      ...
      <section class="breadcrumb-classic context-dark">
        <div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
          <h1 class="veil reveal-sm-block"><?php echo $lang_ponente3['nombre_ponente']?></h1>
          <div class="offset-sm-top-35">
            <ul class="list-inline list-inline-lg list-inline-dashed p">
              <li><a href="index"><?php echo $lang_header['inicio']?></a></li>
              <li><a href="index"><?php echo $lang_ponente3['nombre_ponente']?></a>
              </li>
            </ul>
          </div>
        </div>
                ...
                <div class="offset-top-50">
                  ...
                  <div data-type="horizontal" class="responsive-tabs responsive-tabs-classic horizontal">
                    <ul data-group="tabs-group-default" class="resp-tabs-list tabs-1 text-center tabs-group-default">
                      <li><h3 style="text-align: center; color: #004e9a; "><?php echo $lang_ponente3['nombre_ponente']?> </h3></li>
                      <li><h3 style="text-align: center;color:  #004e9a;"><?php echo $lang_header['conferencia']?></h3></li>
                    </ul>
                    <div data-group="tabs-group-default" class="resp-tabs-container text-sm-left tabs-group-default">
                      <div>
                        <p style="font-size: 1.3em;">
                          <?php echo $lang_ponente3['biografia']?>
                      ...
                      <div>
                        <p>
                        <h4 style="color: #004e9a "><?php echo $lang_ponente3['titulo_ponencia']?></h4>
                        <?php echo $lang_ponente3['resumen_ponencia']?>
