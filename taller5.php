...
?>
		...
		<section class="breadcrumb-classic context-dark">
			<div class="shell section-30 section-sm-top-70 section-sm-bottom-60">
				<h1 class="veil reveal-sm-block"><?echo $lang_talleres['titulo_taller5']?></h1>
				...
				<div class="shell">
					<div class="range range-xs-center">
						<div class="cell-xs-10 cell-lg-12">
							<h2 class="text-bold"><?echo $lang_talleres['titulo_taller5']?> </h2>
							...
							<div class="offset-top-60">
								...
								<div data-type="vertical" class="responsive-tabs responsive-tabs-boxed vertical">
									<ul data-group="tabs-group-default" class="resp-tabs-list text-center tabs-group-default">
										...
										<li><?echo $lang_talleres['ponentes_taller5']?> </li>
										...
										<div>
											 <ul>
											<li>
											<?echo $lang_talleres['fecha']?>: <?echo $lang_talleres['fecha_taller5']?>
											</li>
											<li>
													<?echo $lang_talleres['horario']?>: <?echo $lang_talleres['horario_taller5']?>
											</li>
											<li>
										...
										<div>
										<h3><?echo $lang_talleres['impartido']?> <strong><?echo $lang_talleres['ponentes_taller5']?></strong></h3>
											<?echo $lang_talleres['adscripcion_taller5']?>
											<h3><?echo $lang_talleres['perfil']?></h3>

						<?echo $lang_talleres['cvu_taller5']?>

										</div>
										<div>
										<ol>
											<?echo $lang_talleres['contenido_taller5']?>
										</ol>


										</div>
										<div>
											<?echo $lang_talleres['requerimientos_taller5']?>
